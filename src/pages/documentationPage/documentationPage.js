        ...
        <div className="container">
            ...
            <section className="section">
                ...
                <section className="endpoint-section">
                    ...
                    <pre>
                        <code>{`GET baseURL/api/facts?quant=5&tag=ProgrammingLanguages\nx-api-key: {API_KEY}`}</code>
                    </pre>
            ...
            <section className="section">
                ...
                <ul>
                    <li>
                        <a href="https://vedansh-dubey.github.io/facts-api/#/login">API Dashboard</a> - Required for authentication and quota verification.
                    </li>
                </ul>
                <pre style={{ color: "red" }}>
